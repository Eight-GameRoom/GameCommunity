...
public class CommentController {
    ...
    public ResponseEntity<ApiResponse<CommentResponseDto>> createComment(
        ...
        CommentResponseDto commentResponseDto = commentService.createComment(user, postId, commentRequestDto);
    ...
    public ResponseEntity<ApiResponse<CommentResponseDto>> updateComment(
        ...
        User user = userDetails.getUser();
        CommentResponseDto commentResponseDto = commentService.updateComment(user, commentId, commentRequestDto);
    ...
    public ResponseEntity<ApiResponse<List<CommentResponseDto>>> getComment(
            @AuthenticationPrincipal UserDetailsImpl userDetails,
            @PathVariable Long postId) {
        List<CommentResponseDto> commentResponseDtos = commentService.getComment(postId);
